# B4 gain-shift implementation notes (Phase 0 prototype)

**Status: SOLVED with the in-place mechanism. No FITS rewrite needed.**
This was the highest-risk part of the B4 implementation,
and it is now de-risked.

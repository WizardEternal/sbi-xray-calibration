...
# ----------------------------------------------------------------------------
SEED = 20260611
SEED_OFFSET = 3                 # medium level's offset in the prod config
EXPOSURE_S = 3534.0              # prod medium exposure (~986 counts)
N_TRAIN = 50000
...
SIM_PATH = ROOT / "data" / "sim" / "modelA_prod_gainmarg_bright.npz"
MODEL_DIR = ROOT / "outputs" / "gain_marg" / "model_bright"
...
def get_training_data():
    ...
    print(f"[sim] generating {N_TRAIN} gain-augmented spectra (bright, {EXPOSURE_S}s)...")
